# Topsis-Krit-102303213

TOPSIS (Technique for Order Preference by Similarity to Ideal Solution) command-line package by **Krit Mukul** (Roll 102303213).

**Repository**: https://github.com/KritMukul/TOPSIS
...
```bash
pip install Topsis-Krit-102303213
```

### Local development

```bash
git clone https://github.com/KritMukul/TOPSIS.git
cd TOPSIS
pip install -e .
```
...
```bash
python -m topsis <InputDataFile> <Weights> <Impacts> <OutputResultFile>
```
...
All these steps are implemented efficiently using NumPy and Pandas in [topsis/core.py](topsis/core.py).
...
```bash
pip install Topsis-Krit-102303737
topsis-cli --help
```
